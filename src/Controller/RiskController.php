...
class RiskController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/risk_edit", name="risk_edit", methods={"GET","POST"})
     * @ParamConverter("risk", options={"id" = "id"})
     */
    public function edit(Request $request, Risk $risk, EntityManagerInterface $manager): Response
    {
        $form = $this->createFormBuilder($risk)
            ->add('typeOfRisk', ChoiceType::class, [
                'choices'  => [
        ...
        return $this->render('view/risk/edit.html.twig', [
            'controller_name' => 'RiskController',
            'formRisk' => $form->createView(),
            'risks' => $risks,
            'repvisu' => $repvisu,
    ...
    /**
     * @Route("/{id}/risk_delete", name="risk_delete", methods={"POST"})
     * @ParamConverter("risk", options={"id" = "id"})
     */
