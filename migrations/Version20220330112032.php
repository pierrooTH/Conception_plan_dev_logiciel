 ...
 */
final class Version20220330112032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tache (id INT AUTO_INCREMENT NOT NULL, letter VARCHAR(1) NOT NULL, previousLetter VARCHAR(5) NOT NULL, description VARCHAR(100) NOT NULL, duration INT NOT NULL, level INT DEFAULT NULL, UNIQUE INDEX UNIQ_938720758E02EE0A (letter), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
